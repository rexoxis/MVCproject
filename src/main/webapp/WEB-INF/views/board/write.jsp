        ...
        <div class="row" style="margin: 10px 30px 20px 50px">
            <form class="card card-body bg-light" name="bdfrm" method="post">
                <div class="form-group row">
                    ...
                    <input type="text" id="title" name="subject" class="form-control col-9">
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-2 text-right" for="contents">본문내용</label>
                    <textarea rows="20" type="text" id="contents" name="contents" class="form-control col-9"></textarea>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-2 text-right" for="captcha">자동 등록방지</label>
                    <iframe src="/resources/img/captchav1.png" frameborder="0" scrolling="no" width="300" height="100"></iframe>
                    <input type="text" id="captcha" name="cap" class="form-control col-3" style="margin-left: 170px">&nbsp;
...
<script>
    ...
    $(function() {
        $('#cbtn').on('click',function(e) {location.href='/board/list';});
    });
</script>
</body>
</html>