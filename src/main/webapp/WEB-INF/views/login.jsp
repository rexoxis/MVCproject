...
<%--<%--%>
    ...
    <%--String isfail = request.getParameter("error");--%>
    <%--String msg = "";--%>

    <%--if(isfail != null && isfail.equals("1")){--%>
...
<%--<div class="container">--%>
    ...
    <%--<div id="main">--%>
        <%--<%=msg%>--%>
        <%--<form id="loginfrm" name="loginfrm" action="proclogin.jsp" method="post">--%>
            <%--<div class="form-group row text-center">--%>
                <%--<label for="uid" class="col-form-label col-4">아이디</label>--%>
                <%--<input type="text" id="uid" name="userid" class="form-control col-3" >--%>
            <%--</div>--%>
            <%--<div class="form-group row text-center">--%>
                <%--<label for="pwd" class="col-form-label col-4">비밀번호</label>--%>
                <%--<input type="password" id="pwd" name="passwd" class="form-control col-3" >--%>
            <%--</div>--%>
