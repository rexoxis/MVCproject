    ...
    <div id="main">
        ...
        <div class="card card-body bg-ligt" style="margin: 10px 30px 20px 50px">
            ...
            <form>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <button type="button" id="vcodebtn" class="btn btn-primary"><i class="fa fa-check"> 입력완료</i></button>
...
<script>
    ...
    $(function() {
        $('#vcodebtn').on('click',function(e) {location.href='/join/joinmember';});
    });
</script>
</body>
</html>