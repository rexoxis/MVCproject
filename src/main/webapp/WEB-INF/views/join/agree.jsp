    ...
    <div id="main">
        ...
        <nav aria-label="breadcrumb">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><span class="badge badge-light" style="padding: 5px">실명확인</span></li>
        ...
        <div style="margin: 50px 0 20px 0">
            <h2>사이트 약관동의</h2>
            <small class="text-muted">회원가입을 위해서 이용약관&middot;개인정보 수집에 동의가 필요합니다.</small>
        </div>
        ...
        <div class="card card-body bg-light" style="margin: 10px 30px 0 50px">
            ...
            <form>
                <div class="form-group">
                    <textarea wrap="hard" rows="10" class="form-control">네이버 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 네이버 서비스의 이용과 관련하여 네이버 서비스를 제공하는 네이버 주식회사(이하 ‘네이버’)와 이를 이용하는 네이버 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 네이버 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
...
네이버 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.</textarea>
        ...
        <div class="card card-body bg-light" style="margin: 5px 30px 0 50px">
...
참고로 네이버는 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.</textarea>
        ...
        <div class="text-center" style="margin: 10px 0">
            ...
            <button class="btn btn-danger" type="button" id="notagree" onclick="javascript:history.go(-1);">동의하지 않습니다.</button>
        </div>
...
<script>
    ...
    $(function() {
        $('#agreebtn').on('click',function(e) {location.href='/join/checkme1';});
    });
</script>
